...
{
	$database->addUser(substr( md5(rand()), 0, 5) . '@' . substr( md5(rand()), 0, 7) . '.' . 'fi', 'salasanaqwerty');
}
...
<body>
	<?php sidebar(); ?>
	<div id="top-bar">
			<h2 id="top-header">Statistics</h2>
	</div>
	<div id="content">
		<div class="item"><?php test(); ?></div>
		<div class="item"><?php totalStats(); ?></div>
		<div class="item"><?php activity(); ?></div>
	</div>
</body>
</html>